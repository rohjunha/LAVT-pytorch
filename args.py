...
def get_parser():
    parser = argparse.ArgumentParser(description="Referring Segmentation codebase")
    # Dataset
    parser.add_argument('--dataset', default='refcoco',
                        help='choose one of the following datasets: refcoco, refcoco+, refcocog')
    # BERT 
    ...
    # config file
    parser.add_argument("--cfg_file", default="configs/swin_base_patch4_window7_224.yaml", type=str,
                        help="config file define dataset and model")
    # optimizer set
    parser.add_argument("--lr", default=1.5e-5, type=float, help="initial learning rate")
